...
import { getAllBooks, getBookById, createBooks, updataBooks, deleteBooks, updataExistence,availableBooks } from "../Controller/libro_controller.js";
const router= Router ();
...
router.get('/libros/disponibles', availableBooks);
